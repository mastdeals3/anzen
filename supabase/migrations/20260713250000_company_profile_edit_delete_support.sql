-- ============================================================================
-- Company Profile Edit & Delete Support (2026-07-13)
-- ============================================================================
...
--   3. Replace get_company_profile_reference_counts() (defined first so the
--      trigger can call it).
--   4. Replace protect_historical_company_profile trigger function with the
--      reference-count based rule (was: effective_from-based).
--   5. Add delete_company_profile(id) — clean PROFILE_REFERENCED error.
--
...
-- Notes-only updates are always allowed (audit metadata). Any other field
-- change or DELETE on a referenced profile is blocked.
...
-- Trigger definition itself is unchanged from 20260713240000.
