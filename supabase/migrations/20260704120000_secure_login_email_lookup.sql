...
--
-- Login architecture is unchanged: the frontend still resolves username -> email
-- before calling supabase.auth.signInWithPassword(email, password). Only the
-- lookup mechanism changes (bulk table SELECT -> scoped RPC).
